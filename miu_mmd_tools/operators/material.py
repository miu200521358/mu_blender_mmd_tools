...
from miu_mmd_tools import cycles_converter
from miu_mmd_tools.core.material import FnMaterial
from miu_mmd_tools.core.exceptions import MaterialNotFoundError
from miu_mmd_tools.core.shader import _NodeGroupUtils

@register_wrap
class ConvertMaterialsForCycles(Operator):
    bl_idname = 'miu_mmd_tools.convert_materials_for_cycles'
...
class OpenTexture(Operator, _OpenTextureBase):
    bl_idname = 'miu_mmd_tools.material_open_texture'
...
class RemoveTexture(Operator):
    """ Create a texture for mmd model material.
    """
    bl_idname = 'miu_mmd_tools.material_remove_texture'
...
class OpenSphereTextureSlot(Operator, _OpenTextureBase):
    """ Create a texture for mmd model material.
    """
    bl_idname = 'miu_mmd_tools.material_open_sphere_texture'
...
class RemoveSphereTexture(Operator):
    """ Create a texture for mmd model material.
    """
    bl_idname = 'miu_mmd_tools.material_remove_sphere_texture'
...
class MoveMaterialUp(Operator):
    bl_idname = 'miu_mmd_tools.move_material_up'
...
class MoveMaterialDown(Operator):
    bl_idname = 'miu_mmd_tools.move_material_down'
...
class EdgePreviewSetup(Operator):
    bl_idname = 'miu_mmd_tools.edge_preview_setup'
