...
from miu_mmd_tools import utils
from miu_mmd_tools.utils import ItemOp, ItemMoveOp
from miu_mmd_tools.core.material import FnMaterial
from miu_mmd_tools.core.morph import FnMorph
from miu_mmd_tools.core.exceptions import MaterialNotFoundError, DivisionError
...
class AddMorph(Operator):
    bl_idname = 'miu_mmd_tools.morph_add'
    bl_label = 'Add Morph'
...
class RemoveMorph(Operator):
    bl_idname = 'miu_mmd_tools.morph_remove'
    ...
    def execute(self, context):
        ...
        if morph_type.startswith('material'):
            bpy.ops.miu_mmd_tools.clear_temp_materials()
        elif morph_type.startswith('uv'):
            bpy.ops.miu_mmd_tools.clear_uv_morph_view()
...
class MoveMorph(Operator, ItemMoveOp):
    bl_idname = 'miu_mmd_tools.morph_move'
    bl_label = 'Move Morph'
...
class CopyMorph(Operator):
    bl_idname = 'miu_mmd_tools.morph_copy'
    bl_label = 'Copy Morph'
...
class AddMorphOffset(Operator):
    bl_idname = 'miu_mmd_tools.morph_offset_add'
...
class RemoveMorphOffset(Operator):
    bl_idname = 'miu_mmd_tools.morph_offset_remove'
...
class InitMaterialOffset(Operator):
    bl_idname = 'miu_mmd_tools.material_morph_offset_init'
...
class ApplyMaterialOffset(Operator):
    bl_idname = 'miu_mmd_tools.apply_material_morph_offset'
...
class CreateWorkMaterial(Operator):
    bl_idname = 'miu_mmd_tools.create_work_material'
...
class ClearTempMaterials(Operator):
    bl_idname = 'miu_mmd_tools.clear_temp_materials'
...
class ViewBoneMorph(Operator):
    bl_idname = 'miu_mmd_tools.view_bone_morph'
...
class ClearBoneMorphView(Operator):
    bl_idname = 'miu_mmd_tools.clear_bone_morph_view'
...
class ApplyBoneMorph(Operator):
    bl_idname = 'miu_mmd_tools.apply_bone_morph'
...
class SelectRelatedBone(Operator):
    bl_idname = 'miu_mmd_tools.select_bone_morph_offset_bone'
...
class EditBoneOffset(Operator): 
    bl_idname = 'miu_mmd_tools.edit_bone_morph_offset'
...
class ApplyBoneOffset(Operator):
    bl_idname = 'miu_mmd_tools.apply_bone_morph_offset'
...
class ViewUVMorph(Operator):
    bl_idname = 'miu_mmd_tools.view_uv_morph'
...
class ClearUVMorphView(Operator):
    bl_idname = 'miu_mmd_tools.clear_uv_morph_view'
...
class EditUVMorph(Operator):
    bl_idname = 'miu_mmd_tools.edit_uv_morph'
...
class ApplyUVMorph(Operator):
    bl_idname = 'miu_mmd_tools.apply_uv_morph'
