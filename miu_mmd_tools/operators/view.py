...
class SetGLSLShading(Operator, _SetShadingBase):
    bl_idname = 'miu_mmd_tools.set_glsl_shading'
    bl_label = 'GLSL View'
...
class SetShadelessGLSLShading(Operator, _SetShadingBase):
    bl_idname = 'miu_mmd_tools.set_shadeless_glsl_shading'
...
class ResetShading(Operator, _SetShadingBase):
    bl_idname = 'miu_mmd_tools.reset_shading'
    bl_label = 'Reset View'
...
class FlipPose(Operator):
    bl_idname = 'miu_mmd_tools.flip_pose'
    bl_label = 'Flip Pose'
