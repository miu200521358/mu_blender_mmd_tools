...
class SelectRigidBody(Operator):
    bl_idname = 'miu_mmd_tools.rigid_body_select'
...
class AddRigidBody(Operator):
    bl_idname = 'miu_mmd_tools.rigid_body_add'
...
class RemoveRigidBody(Operator):
    bl_idname = 'miu_mmd_tools.rigid_body_remove'
...
class AddJoint(Operator): 
    bl_idname = 'miu_mmd_tools.joint_add'
    bl_label = 'Add Joint'
...
class RemoveJoint(Operator):
    bl_idname = 'miu_mmd_tools.joint_remove'
...
class UpdateRigidBodyWorld(Operator):
    bl_idname = 'miu_mmd_tools.rigid_body_world_update'
