...
from miu_mmd_tools.bpyutils import ObjectOp
from miu_mmd_tools.core import model as mmd_model
...
class MoveObject(Operator, utils.ItemMoveOp):
    bl_idname = 'miu_mmd_tools.object_move'
...
class CleanShapeKeys(Operator):
    bl_idname = 'miu_mmd_tools.clean_shape_keys'
...
class SeparateByMaterials(Operator):
    bl_idname = 'miu_mmd_tools.separate_by_materials'
    ...
    def __separate_by_materials(self, obj):
        ...
        if self.clean_shape_keys:
            bpy.ops.miu_mmd_tools.clean_shape_keys()
...
class JoinMeshes(Operator):
    bl_idname = 'miu_mmd_tools.join_meshes'
...
class AttachMeshesToMMD(Operator):
    bl_idname = 'miu_mmd_tools.attach_meshes'
...
class ChangeMMDIKLoopFactor(Operator):
    bl_idname = 'miu_mmd_tools.change_mmd_ik_loop_factor'
...
class RecalculateBoneRoll(Operator):
    bl_idname = 'miu_mmd_tools.recalculate_bone_roll'
