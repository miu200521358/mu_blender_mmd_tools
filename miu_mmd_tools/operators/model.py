...
from miu_mmd_tools.core.bone import FnBone
...
class MorphSliderSetup(Operator):
    bl_idname = 'miu_mmd_tools.morph_slider_setup'
...
class CleanRiggingObjects(Operator):
    bl_idname = 'miu_mmd_tools.clean_rig'
    bl_label = 'Clean Rig'
...
class BuildRig(Operator):
    bl_idname = 'miu_mmd_tools.build_rig'
    bl_label = 'Build Rig'
...
class CleanAdditionalTransformConstraints(Operator):
    bl_idname = 'miu_mmd_tools.clean_additional_transform'
...
class ApplyAdditionalTransformConstraints(Operator):
    bl_idname = 'miu_mmd_tools.apply_additional_transform'
...
class SetupBoneFixedAxes(Operator):
    bl_idname = 'miu_mmd_tools.bone_fixed_axis_setup'
...
class SetupBoneLocalAxes(Operator):
    bl_idname = 'miu_mmd_tools.bone_local_axes_setup'
...
class CreateMMDModelRoot(Operator):
    bl_idname = 'miu_mmd_tools.create_mmd_model_root_object'
...
class ConvertToMMDModel(Operator):
    bl_idname = 'miu_mmd_tools.convert_to_mmd_model'
    ...
    def __configure_rig(self, rig):
        ...
        from miu_mmd_tools.operators.display_item import DisplayItemQuickSetup
...
class TranslateMMDModel(Operator):
    bl_idname = 'miu_mmd_tools.translate_mmd_model'
