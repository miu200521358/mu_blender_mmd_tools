...
class AddDisplayItemFrame(Operator):
    bl_idname = 'miu_mmd_tools.display_item_frame_add'
...
class RemoveDisplayItemFrame(Operator):
    bl_idname = 'miu_mmd_tools.display_item_frame_remove'
...
class MoveDisplayItemFrame(Operator, ItemMoveOp):
    bl_idname = 'miu_mmd_tools.display_item_frame_move'
...
class AddDisplayItem(Operator):
    bl_idname = 'miu_mmd_tools.display_item_add'
...
class RemoveDisplayItem(Operator):
    bl_idname = 'miu_mmd_tools.display_item_remove'
...
class MoveDisplayItem(Operator, ItemMoveOp):
    bl_idname = 'miu_mmd_tools.display_item_move'
...
class FindDisplayItem(Operator):
    bl_idname = 'miu_mmd_tools.display_item_find'
...
class SelectCurrentDisplayItem(Operator):
    bl_idname = 'miu_mmd_tools.display_item_select_current'
...
class DisplayItemQuickSetup(Operator):
    bl_idname = 'miu_mmd_tools.display_item_quick_setup'
