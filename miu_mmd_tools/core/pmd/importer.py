...
import miu_mmd_tools.core.pmx.importer as import_pmx
import miu_mmd_tools.core.pmd as pmd
import miu_mmd_tools.core.pmx as pmx
...
def import_pmd_to_pmx(filepath):
    ...
    logging.info('')
    logging.info('****************************************')
    logging.info(' miu_mmd_tools.import_pmd module')
    logging.info('----------------------------------------')
    logging.info(' Start to convert pmd data into pmx data')
    logging.info('              by the miu_mmd_tools.pmd modlue.')
    logging.info('')
