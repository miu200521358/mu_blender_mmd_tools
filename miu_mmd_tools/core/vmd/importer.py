...
class _MirrorMapper:
    def __init__(self, data_map=None):
        from miu_mmd_tools.operators.view import FlipPose
...
class BoneConverter:
    ...
    def convert_rotation_from_qq(self, qq):
        return Quaternion(matmul(self.__mat, qq.axis) * -1, qq.angle).normalized()
