...
from miu_mmd_tools.core.vmd.importer import BoneConverter, BoneConverterPoseMode
from miu_mmd_tools import bpyutils
from miu_mmd_tools.utils import saferelpath
...
class __PmxExporter:
    ...
    def execute(self, filepath, **args):
        ...
        self.__model.comment = 'exported by miu_mmd_tools'
        self.__model.comment_e = 'exported by miu_mmd_tools'
