...
class MMDModelObjectPanel(_PanelBase, Panel):
    bl_idname = 'OBJECT_PT_miu_mmd_tools_root_object'
    ...
    def draw(self, context):
        ...
        c = layout.column()
        c.operator('miu_mmd_tools.change_mmd_ik_loop_factor', text='Change MMD IK Loop Factor')
        c.operator('miu_mmd_tools.recalculate_bone_roll', text='Recalculate bone roll')

@register_wrap
class MMDRigidPanel(_PanelBase, Panel):
    bl_idname = 'RIGID_PT_miu_mmd_tools_bone'
...
class MMDJointPanel(_PanelBase, Panel):
    bl_idname = 'JOINT_PT_miu_mmd_tools_bone'
    bl_label = 'MMD Joint'
