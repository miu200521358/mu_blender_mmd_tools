...
from miu_mmd_tools import operators
from miu_mmd_tools.utils import ItemOp
from miu_mmd_tools.bpyutils import SceneOp
import miu_mmd_tools.core.model as mmd_model
...
class MMDToolsObjectPanel(_PanelBase, Panel):
    bl_idname = 'OBJECT_PT_miu_mmd_tools_object'
    bl_label = 'Operator'
    bl_context = ''
    ...
    def draw(self, context):
        ...
        row = layout.row()
        col = row.column(align=True)
        col.operator('miu_mmd_tools.export_vmd', text='多段モーション出力')
...
class MMDDisplayItemFrameMenu(Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator_enum('miu_mmd_tools.display_item_quick_setup', 'type')
        layout.separator()
...
class MMDDisplayItemMenu(Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator('miu_mmd_tools.display_item_remove', text='Delete All', icon='X').all = True
        layout.separator()
        layout.operator('miu_mmd_tools.display_item_move', icon=TRIA_UP_BAR, text='Move To Top').type = 'TOP'
        layout.operator('miu_mmd_tools.display_item_move', icon=TRIA_DOWN_BAR, text='Move To Bottom').type = 'BOTTOM'


class MMDDisplayItemsPanel(_PanelBase, Panel):
    bl_idname = 'OBJECT_PT_miu_mmd_tools_display_items'
    ...
    def draw(self, context):
        ...
        tb1.operator('miu_mmd_tools.display_item_frame_add', text='', icon=ICON_ADD)
        tb1.operator('miu_mmd_tools.display_item_frame_remove', text='', icon=ICON_REMOVE)
        tb1.menu('OBJECT_MT_miu_mmd_tools_display_item_frame_menu', text='', icon='DOWNARROW_HLT')
        tb.separator()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.display_item_frame_move', text='', icon='TRIA_UP').type = 'UP'
        tb1.operator('miu_mmd_tools.display_item_frame_move', text='', icon='TRIA_DOWN').type = 'DOWN'
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.display_item_add', text='', icon=ICON_ADD)
        tb1.operator('miu_mmd_tools.display_item_remove', text='', icon=ICON_REMOVE)
        tb1.menu('OBJECT_MT_miu_mmd_tools_display_item_menu', text='', icon='DOWNARROW_HLT')
        tb.separator()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.display_item_move', text='', icon='TRIA_UP').type = 'UP'
        tb1.operator('miu_mmd_tools.display_item_move', text='', icon='TRIA_DOWN').type = 'DOWN'

        row = col.row()
        r = row.row(align=True)
        r.operator('miu_mmd_tools.display_item_find', text='Bone', icon='VIEWZOOM').type = 'BONE'
        r.operator('miu_mmd_tools.display_item_find', text='Morph', icon='VIEWZOOM').type = 'MORPH'
...
class MMDMorphMenu(Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator('miu_mmd_tools.morph_remove', text='Delete All', icon='X').all = True
        layout.separator()
        layout.operator_enum('miu_mmd_tools.morph_slider_setup', 'type')
        layout.separator()
        layout.operator('miu_mmd_tools.morph_copy', icon='COPY_ID')
        layout.separator()
        layout.operator('miu_mmd_tools.morph_move', icon=TRIA_UP_BAR, text='Move To Top').type = 'TOP'
        layout.operator('miu_mmd_tools.morph_move', icon=TRIA_DOWN_BAR, text='Move To Bottom').type = 'BOTTOM'


class MMDMorphToolsPanel(_PanelBase, Panel):
    bl_idname = 'OBJECT_PT_miu_mmd_tools_morph_tools'
    ...
    def draw(self, context):
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.morph_add', text='', icon=ICON_ADD)
        tb1.operator('miu_mmd_tools.morph_remove', text='', icon=ICON_REMOVE)
        tb1.menu('OBJECT_MT_miu_mmd_tools_morph_menu', text='', icon='DOWNARROW_HLT')
        tb.separator()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.morph_move', text='', icon='TRIA_UP').type = 'UP'
        tb1.operator('miu_mmd_tools.morph_move', text='', icon='TRIA_DOWN').type = 'DOWN'
    ...
    def _template_morph_offset_list(self, layout, morph, list_type_name):
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.morph_offset_add', text='', icon=ICON_ADD)
        tb1.operator('miu_mmd_tools.morph_offset_remove', text='', icon=ICON_REMOVE)
        tb.operator('miu_mmd_tools.morph_offset_remove', text='', icon='X').all = True
        return ItemOp.get_by_index(morph.data, morph.active_data)

    def _draw_vertex_data(self, context, rig, col, morph):
        row = col.row()
        col = row.column()
        row.operator('miu_mmd_tools.morph_offset_remove', text='', icon='X').all = True
        for i in rig.meshes():
...
class MMDRigidbodySelectMenu(Menu):
    ...
    def draw(self, context):
        ...
        layout.operator('miu_mmd_tools.rigid_body_select', text='Select Similar...')
        layout.separator()
...
class MMDRigidbodyMenu(Menu):
    ...
    def draw(self, context):
        ...
        layout.menu('OBJECT_MT_miu_mmd_tools_rigidbody_select_menu', text='Select Similar')
        layout.separator()
        layout.operator('miu_mmd_tools.object_move', icon=TRIA_UP_BAR, text='Move To Top').type = 'TOP'
        layout.operator('miu_mmd_tools.object_move', icon=TRIA_DOWN_BAR, text='Move To Bottom').type = 'BOTTOM'


class MMDRigidbodySelectorPanel(_PanelBase, Panel):
    bl_idname = 'OBJECT_PT_miu_mmd_tools_rigidbody_list'
    ...
    def draw(self, context):
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.rigid_body_add', text='', icon=ICON_ADD)
        tb1.operator('miu_mmd_tools.rigid_body_remove', text='', icon=ICON_REMOVE)
        tb1.menu('OBJECT_MT_miu_mmd_tools_rigidbody_menu', text='', icon='DOWNARROW_HLT')
        tb.separator()
        tb1 = tb.column(align=True)
        tb1.enabled = active_obj.mmd_type == 'RIGID_BODY'
        tb1.operator('miu_mmd_tools.object_move', text='', icon='TRIA_UP').type = 'UP'
...
class MMDJointSelectorPanel(_PanelBase, Panel):
    bl_idname = 'OBJECT_PT_miu_mmd_tools_joint_list'
    bl_label = 'Joints'
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        tb = row.column()
        tb1 = tb.column(align=True)
        tb1.operator('miu_mmd_tools.joint_add', text='', icon=ICON_ADD)
        tb1.operator('miu_mmd_tools.joint_remove', text='', icon=ICON_REMOVE)
        tb1.menu('OBJECT_MT_miu_mmd_tools_joint_menu', text='', icon='DOWNARROW_HLT')
        tb.separator()
        tb1 = tb.column(align=True)
