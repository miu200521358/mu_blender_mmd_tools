...
class MMDBonePanel(Panel):
    bl_idname = 'BONE_PT_miu_mmd_tools_bone'
    ...
    def draw(self, context):
        ...
        row.operator('miu_mmd_tools.bone_fixed_axis_setup', text='', icon='X').type = 'DISABLE'
        row.operator('miu_mmd_tools.bone_fixed_axis_setup', text='Load').type = 'LOAD'
        row.operator('miu_mmd_tools.bone_fixed_axis_setup', text='Apply').type = 'APPLY'
        row = c.row()
        ...
        row.operator('miu_mmd_tools.bone_local_axes_setup', text='', icon='X').type = 'DISABLE'
        row.operator('miu_mmd_tools.bone_local_axes_setup', text='Load').type = 'LOAD'
        row.operator('miu_mmd_tools.bone_local_axes_setup', text='Apply').type = 'APPLY'
        row = c.row()
