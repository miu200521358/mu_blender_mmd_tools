...
from miu_mmd_tools.core.model import getRigidBodySize, Model
...
def _get_bone(prop):
    obj = prop.id_data
    relation = obj.constraints.get('miu_mmd_tools_rigid_parent', None)
    if relation:
        arm = relation.target
...
def _set_bone(prop, value):
    ...
    if relation is None:
        ...
        relation.name = 'miu_mmd_tools_rigid_parent'
        relation.mute = True
